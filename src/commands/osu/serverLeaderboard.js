...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription("View the server's top 15 players!")
    ...
    async execute(interaction, client) {
        ...
        if (mode == 'inventory') {
            cardLeaderboard(interaction, client);
        } else if (mode == 'level') {
            levelLeaderboard(interaction, client);
        } else {
            globalLeaderboard(interaction, client, mode);
        }
    }
};