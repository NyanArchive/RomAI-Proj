...
const { simulateNewEloSystem, simulatePlacementElo } = require("../../utils/tests/newRatingSystem");
const { checkSeasonReset } = require("../../utils/components/rankedLoop");
        ...
        try {
            ...
            if (message.content.startsWith(syntax)) {
                ...
                if (getCommand == "rs" || getCommand == "recent" || getCommand == "r") {
                    ...
                    await message.reply(reply);
                } /*else if (getCommand == "seasonreset" && message.author.username == "romdarker") {
