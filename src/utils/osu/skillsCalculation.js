...
module.exports = {
     ...
     */
    async getPlacementElo(rating, opponentRating, score) {
        let kFactor = 50;
        ...
        // ELO change cap
        if (Math.round(newRating) > 1800 && Math.round(newRating) - rating > 24) {
            return rating + 24;
        } else if (Math.round(newRating) < 1200 && Math.round(newRating) - rating < -24) {
            return rating - 24;
        }
