    ...
    async playerCard(interaction, client, username, message, pack, glowing = false) {
        ...
        try {
            ...
            const processScore = async (score) => {
                ...
                skillAverages.starRating += beatmapCalc.difficulty.starRating;
                ...
                skillAverages.mapCombo += beatmapCalc.difficulty.maxCombo;
            ...
            await Promise.all(
                scoresV2.map(score => scoreLimit(() => processScore(score)))
            );
            ...
            const skillAccuracy = await accuracyCalc(skillAim, normalize(skillAverages.accuracy), normalize(skillAverages.scoreStarRating), normalize(skillAverages.playerCombo), normalize(skillAverages.mapCombo), skillSpeed, normalize(skillAverages.overallDifficulty), normalize(skillAverages.hpDrain));
            ...
            const skillAccFix = await accuracyCalc(skillAimFix, normalize(skillAverages.fixAccuracy), normalize(skillAverages.scoreStarRating), normalize(skillAverages.mapCombo), normalize(skillAverages.mapCombo), skillSpeed, normalize(skillAverages.overallDifficulty), normalize(skillAverages.hpDrain));
